...
| 6. Professor — alunos e acesso | 12 | 3 | 1 | 8 | 0 |
...
| **Prioridade alta abaixo de 75%** | aluno.js:5590, badge :3800 | ❌ | | pendente |
| **Executar o reforço do ciclo** (site) | `iniciarReforcoCicloSmart` aluno.js:5658 | 🟡 | | pendente |
| **Conduzir as fases `reinforcement` e `extra`** (extensão) | content.js:261 e :280 | ❌ | | pendente |
...
| **Grade de revisão espaçada** (1ª e 2ª revisão por caderno) | `renderControleRevisoes` aluno.js:3164 | ❌ | | pendente |
...
| **Prévia da semana antes de salvar** | `gerarPreviaMetasTeoriaAluno` professor.js:5558 | ❌ | | pendente |
| **Distribuição por peso da matéria** (`contatosSemanais`) | `calcularDistribuicaoPadraoBlocos` professor.js:5006 | ❌ | | pendente |
| **Rodízio de blocos B1→B2→…→Bn→B1** | `proximoBlocoParaMeta` professor.js:5544 | 🟡 | 04 | — |
...
| Controle manual de revisões | `renderControleRevisoes` professor.js:1792 | ❌ | | pendente |
...
| **Fase de reforço correlato** (1 do mesmo tópico por erro, profundidade 2) | `pickReinforcement` content.js:261 | ❌ | | pendente |
| **Rodada extra de +5, tudo ou nada** | `appendExtraRound` content.js:280 | ❌ | | pendente |
